...
class Client{
    ...
    public:
        Client();
        Client(int id,int id_agence,string name,string surname,int age,string password,int idcompte_courant,unsigned int solde_courant,int idcompte_epargne1,unsigned int solde_epargne1,int idcompte_epargne2,unsigned int solde_epargne2);
        void set_id(int id);
        void set_id_agence(int id_agence);
